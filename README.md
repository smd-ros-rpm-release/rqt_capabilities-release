## rqt_capabilities (groovy) - 0.1.2-3

The packages in the `rqt_capabilities` repository were released into the `groovy` distro by running `/usr/local/bin/bloom-release -r groovy -t groovy rqt_capabilities` on `Thu, 22 May 2014 01:55:01 -0000`
...
## rqt_capabilities (indigo) - 0.1.2-0
